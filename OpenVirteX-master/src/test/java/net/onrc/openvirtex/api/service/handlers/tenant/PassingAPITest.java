...
public class PassingAPITest extends AbstractAPICalls {
    ...
    public void testCreateSingleSwitch() {
    	...
    	final PhysicalSwitch sw = new PhysicalSwitch(DatapathId.of(1), OFFactories.getFactory(OFVersion.OF_13));
    ...
    public void testCreateBigSwitch() {
    	...
    	final PhysicalSwitch sw1 = new PhysicalSwitch(DatapathId.of(1), OFFactories.getFactory(OFVersion.OF_13));
    	final PhysicalSwitch sw2 = new PhysicalSwitch(DatapathId.of(2), OFFactories.getFactory(OFVersion.OF_13));
