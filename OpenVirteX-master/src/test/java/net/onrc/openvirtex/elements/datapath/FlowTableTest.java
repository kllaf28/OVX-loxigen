...
public class FlowTableTest extends TestCase {
    ...
    public void testAddFlowMod() {
    	...
    	final OVXSwitch vsw = new OVXSingleSwitch(DatapathId.of(1), OFFactories.getFactory(OFVersion.OF_13), 1);
    ...
    public void testHandleFlowMod() {
        ...
        final PhysicalSwitch psw = new PhysicalSwitch(DatapathId.of(0), OFFactories.getFactory(OFVersion.OF_13));
