...
class OFActionNiciraSetNshc4Ver12 implements OFActionNiciraSetNshc4 {
...
//
    ...
    final static OFActionNiciraSetNshc4Ver12 DEFAULT = new OFActionNiciraSetNshc4Ver12(
        DEFAULT_NSHC4
    );
    ...
    public OFVersion getVersion() {
        ...
        public OFActionNiciraSetNshc4 build() {
                ...
                //
                return new OFActionNiciraSetNshc4Ver12(
                    nshc4
                );
        }
...
//
    ...
    static class Reader implements OFMessageReader<OFActionNiciraSetNshc4> {
        ...
        public OFActionNiciraSetNshc4 readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            OFActionNiciraSetNshc4Ver12 actionNiciraSetNshc4Ver12 = new OFActionNiciraSetNshc4Ver12(
                    nshc4
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", actionNiciraSetNshc4Ver12);
    ...
    final static OFActionNiciraSetNshc4Ver12Funnel FUNNEL = new OFActionNiciraSetNshc4Ver12Funnel();
    static class OFActionNiciraSetNshc4Ver12Funnel implements Funnel<OFActionNiciraSetNshc4Ver12> {
    ...
    static class Writer implements OFMessageWriter<OFActionNiciraSetNshc4Ver12> {
        @Override
