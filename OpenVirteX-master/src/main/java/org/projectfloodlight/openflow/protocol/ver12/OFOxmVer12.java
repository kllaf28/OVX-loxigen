    ...
    static class Reader implements OFMessageReader<OFOxm<?>> {
        ...
        public OFOxm<?> readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            switch(typeLen) {
               ...
               case 0x14e04:
                   // discriminator value 0x14e04L=0x14e04L for class OFOxmNshCh1Ver12
                   return OFOxmNshCh1Ver12.READER.readFrom(bb);
               case 0x14f08:
                   // discriminator value 0x14f08L=0x14f08L for class OFOxmNshCh1MaskedVer12
                   return OFOxmNshCh1MaskedVer12.READER.readFrom(bb);
               case 0x15004:
                   // discriminator value 0x15004L=0x15004L for class OFOxmNshCh2Ver12
                   return OFOxmNshCh2Ver12.READER.readFrom(bb);
               case 0x15108:
                   // discriminator value 0x15108L=0x15108L for class OFOxmNshCh2MaskedVer12
                   return OFOxmNshCh2MaskedVer12.READER.readFrom(bb);
               case 0x15204:
                   // discriminator value 0x15204L=0x15204L for class OFOxmNshCh3Ver12
                   return OFOxmNshCh3Ver12.READER.readFrom(bb);
               case 0x15308:
                   // discriminator value 0x15308L=0x15308L for class OFOxmNshCh3MaskedVer12
                   return OFOxmNshCh3MaskedVer12.READER.readFrom(bb);
               case 0x15404:
                   // discriminator value 0x15404L=0x15404L for class OFOxmNshCh4Ver12
                   return OFOxmNshCh4Ver12.READER.readFrom(bb);
               case 0x15508:
                   // discriminator value 0x15508L=0x15508L for class OFOxmNshCh4MaskedVer12
                   return OFOxmNshCh4MaskedVer12.READER.readFrom(bb);
               case 0x14c04:
                   // discriminator value 0x14c04L=0x14c04L for class OFOxmNshSiVer12
                   return OFOxmNshSiVer12.READER.readFrom(bb);
               case 0x14d08:
                   // discriminator value 0x14d08L=0x14d08L for class OFOxmNshSiMaskedVer12
                   return OFOxmNshSiMaskedVer12.READER.readFrom(bb);
               case 0x14a04:
                   // discriminator value 0x14a04L=0x14a04L for class OFOxmNshSpiVer12
                   return OFOxmNshSpiVer12.READER.readFrom(bb);
               case 0x14b08:
                   // discriminator value 0x14b08L=0x14b08L for class OFOxmNshSpiMaskedVer12
                   return OFOxmNshSpiMaskedVer12.READER.readFrom(bb);
               case 0x10004:
