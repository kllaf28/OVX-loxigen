    ...
    static class Reader implements OFMessageReader<OFActionNicira> {
        ...
        public OFActionNicira readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            switch(subtype) {
               ...
               case (short) 0x22:
                   // discriminator value 0x22=0x22 for class OFActionNiciraSetNshc1Ver10
                   return OFActionNiciraSetNshc1Ver10.READER.readFrom(bb);
               case (short) 0x23:
                   // discriminator value 0x23=0x23 for class OFActionNiciraSetNshc2Ver10
                   return OFActionNiciraSetNshc2Ver10.READER.readFrom(bb);
               case (short) 0x24:
                   // discriminator value 0x24=0x24 for class OFActionNiciraSetNshc3Ver10
                   return OFActionNiciraSetNshc3Ver10.READER.readFrom(bb);
               case (short) 0x25:
                   // discriminator value 0x25=0x25 for class OFActionNiciraSetNshc4Ver10
                   return OFActionNiciraSetNshc4Ver10.READER.readFrom(bb);
               case (short) 0x21:
                   // discriminator value 0x21=0x21 for class OFActionNiciraSetNsiVer10
                   return OFActionNiciraSetNsiVer10.READER.readFrom(bb);
               case (short) 0x20:
                   // discriminator value 0x20=0x20 for class OFActionNiciraSetNspVer10
                   return OFActionNiciraSetNspVer10.READER.readFrom(bb);
               case (short) 0x4:
