...
class OFOxmNshSpiMaskedVer13 implements OFOxmNshSpiMasked {
    private static final Logger logger = LoggerFactory.getLogger(OFOxmNshSpiMaskedVer13.class);
    // version: 1.3
...
//
    ...
    final static OFOxmNshSpiMaskedVer13 DEFAULT = new OFOxmNshSpiMaskedVer13(
        DEFAULT_VALUE, DEFAULT_VALUE_MASK
    );

    // package private constructor - used by readers, builders, and factory
    OFOxmNshSpiMaskedVer13(U32 value, U32 mask) {
        if(value == null) {
            throw new NullPointerException("OFOxmNshSpiMaskedVer13: property value cannot be null");
        }
        if(mask == null) {
            throw new NullPointerException("OFOxmNshSpiMaskedVer13: property mask cannot be null");
        }
        this.value = value;
        this.mask = mask;
    }
    ...
    static class BuilderWithParent implements OFOxmNshSpiMasked.Builder {
        final OFOxmNshSpiMaskedVer13 parentMessage;
        ...
        BuilderWithParent(OFOxmNshSpiMaskedVer13 parentMessage) {
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmNshSpiMasked> {
        ...
        public OFOxmNshSpiMasked readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            OFOxmNshSpiMaskedVer13 oxmNshSpiMaskedVer13 = new OFOxmNshSpiMaskedVer13(
                    value,
                      mask
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmNshSpiMaskedVer13);
            return oxmNshSpiMaskedVer13;
        }
    }
    ...
    final static OFOxmNshSpiMaskedVer13Funnel FUNNEL = new OFOxmNshSpiMaskedVer13Funnel();
    static class OFOxmNshSpiMaskedVer13Funnel implements Funnel<OFOxmNshSpiMaskedVer13> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFOxmNshSpiMaskedVer13 message, PrimitiveSink sink) {
            // fixed value property typeLen = 0x14b08L
            sink.putInt(0x14b08);
    ...
    static class Writer implements OFMessageWriter<OFOxmNshSpiMaskedVer13> {
        @Override
        public void write(ChannelBuffer bb, OFOxmNshSpiMaskedVer13 message) {
            // fixed value property typeLen = 0x14b08L
            bb.writeInt(0x14b08);
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFOxmNshSpiMaskedVer13(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFOxmNshSpiMaskedVer13 other = (OFOxmNshSpiMaskedVer13) obj;
