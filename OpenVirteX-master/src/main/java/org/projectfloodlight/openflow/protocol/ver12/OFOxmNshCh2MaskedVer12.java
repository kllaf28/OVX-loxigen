...
class OFOxmNshCh2MaskedVer12 implements OFOxmNshCh2Masked {
    private static final Logger logger = LoggerFactory.getLogger(OFOxmNshCh2MaskedVer12.class);
    // version: 1.2
...
//
    ...
    final static OFOxmNshCh2MaskedVer12 DEFAULT = new OFOxmNshCh2MaskedVer12(
        DEFAULT_VALUE, DEFAULT_VALUE_MASK
    );

    // package private constructor - used by readers, builders, and factory
    OFOxmNshCh2MaskedVer12(U32 value, U32 mask) {
        if(value == null) {
            throw new NullPointerException("OFOxmNshCh2MaskedVer12: property value cannot be null");
        }
        if(mask == null) {
            throw new NullPointerException("OFOxmNshCh2MaskedVer12: property mask cannot be null");
        }
        this.value = value;
        this.mask = mask;
    }
    ...
    public OFOxm<U32> getCanonical() {
        if (U32.NO_MASK.equals(mask)) {
            return new OFOxmNshCh2Ver12(value);
    ...
    static class BuilderWithParent implements OFOxmNshCh2Masked.Builder {
        final OFOxmNshCh2MaskedVer12 parentMessage;
        ...
        BuilderWithParent(OFOxmNshCh2MaskedVer12 parentMessage) {
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmNshCh2Masked> {
        ...
        public OFOxmNshCh2Masked readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            OFOxmNshCh2MaskedVer12 oxmNshCh2MaskedVer12 = new OFOxmNshCh2MaskedVer12(
                    value,
                      mask
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmNshCh2MaskedVer12);
            return oxmNshCh2MaskedVer12;
        }
    }
    ...
    final static OFOxmNshCh2MaskedVer12Funnel FUNNEL = new OFOxmNshCh2MaskedVer12Funnel();
    static class OFOxmNshCh2MaskedVer12Funnel implements Funnel<OFOxmNshCh2MaskedVer12> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFOxmNshCh2MaskedVer12 message, PrimitiveSink sink) {
            // fixed value property typeLen = 0x15108L
            sink.putInt(0x15108);
    ...
    static class Writer implements OFMessageWriter<OFOxmNshCh2MaskedVer12> {
        @Override
        public void write(ChannelBuffer bb, OFOxmNshCh2MaskedVer12 message) {
            // fixed value property typeLen = 0x15108L
            bb.writeInt(0x15108);
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFOxmNshCh2MaskedVer12(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFOxmNshCh2MaskedVer12 other = (OFOxmNshCh2MaskedVer12) obj;
