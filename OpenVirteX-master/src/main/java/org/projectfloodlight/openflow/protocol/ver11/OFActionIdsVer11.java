...
public class OFActionIdsVer11 implements OFActionIds {
    ...
    public OFActionIdNiciraSetNshc1 niciraSetNshc1() {
        throw new UnsupportedOperationException("OFActionIdNiciraSetNshc1 not supported in version 1.1");
    }

    public OFActionIdNiciraSetNshc2 niciraSetNshc2() {
        throw new UnsupportedOperationException("OFActionIdNiciraSetNshc2 not supported in version 1.1");
    }

    public OFActionIdNiciraSetNshc3 niciraSetNshc3() {
        throw new UnsupportedOperationException("OFActionIdNiciraSetNshc3 not supported in version 1.1");
    }

    public OFActionIdNiciraSetNshc4 niciraSetNshc4() {
        throw new UnsupportedOperationException("OFActionIdNiciraSetNshc4 not supported in version 1.1");
    }

    public OFActionIdNiciraSetNsi niciraSetNsi() {
        throw new UnsupportedOperationException("OFActionIdNiciraSetNsi not supported in version 1.1");
    }

    public OFActionIdNiciraSetNsp niciraSetNsp() {
        throw new UnsupportedOperationException("OFActionIdNiciraSetNsp not supported in version 1.1");
    }
