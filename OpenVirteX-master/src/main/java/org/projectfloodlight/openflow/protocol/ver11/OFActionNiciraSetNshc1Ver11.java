...
class OFActionNiciraSetNshc1Ver11 implements OFActionNiciraSetNshc1 {
...
//
    ...
    final static OFActionNiciraSetNshc1Ver11 DEFAULT = new OFActionNiciraSetNshc1Ver11(
        DEFAULT_NSHC1
    );
...
//
    ...
    static class Reader implements OFMessageReader<OFActionNiciraSetNshc1> {
        ...
        public OFActionNiciraSetNshc1 readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            OFActionNiciraSetNshc1Ver11 actionNiciraSetNshc1Ver11 = new OFActionNiciraSetNshc1Ver11(
                    nshc1
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", actionNiciraSetNshc1Ver11);
    ...
    final static OFActionNiciraSetNshc1Ver11Funnel FUNNEL = new OFActionNiciraSetNshc1Ver11Funnel();
    static class OFActionNiciraSetNshc1Ver11Funnel implements Funnel<OFActionNiciraSetNshc1Ver11> {
    ...
    static class Writer implements OFMessageWriter<OFActionNiciraSetNshc1Ver11> {
        @Override
