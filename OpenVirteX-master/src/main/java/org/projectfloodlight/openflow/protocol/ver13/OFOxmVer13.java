    ...
    static class Reader implements OFMessageReader<OFOxm<?>> {
        ...
        public OFOxm<?> readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            switch(typeLen) {
               ...
               case 0x14e04:
                   // discriminator value 0x14e04L=0x14e04L for class OFOxmNshCh1Ver13
                   return OFOxmNshCh1Ver13.READER.readFrom(bb);
               case 0x14f08:
                   // discriminator value 0x14f08L=0x14f08L for class OFOxmNshCh1MaskedVer13
                   return OFOxmNshCh1MaskedVer13.READER.readFrom(bb);
               case 0x15004:
                   // discriminator value 0x15004L=0x15004L for class OFOxmNshCh2Ver13
                   return OFOxmNshCh2Ver13.READER.readFrom(bb);
               case 0x15108:
                   // discriminator value 0x15108L=0x15108L for class OFOxmNshCh2MaskedVer13
                   return OFOxmNshCh2MaskedVer13.READER.readFrom(bb);
               case 0x15204:
                   // discriminator value 0x15204L=0x15204L for class OFOxmNshCh3Ver13
                   return OFOxmNshCh3Ver13.READER.readFrom(bb);
               case 0x15308:
                   // discriminator value 0x15308L=0x15308L for class OFOxmNshCh3MaskedVer13
                   return OFOxmNshCh3MaskedVer13.READER.readFrom(bb);
               case 0x15404:
                   // discriminator value 0x15404L=0x15404L for class OFOxmNshCh4Ver13
                   return OFOxmNshCh4Ver13.READER.readFrom(bb);
               case 0x15508:
                   // discriminator value 0x15508L=0x15508L for class OFOxmNshCh4MaskedVer13
                   return OFOxmNshCh4MaskedVer13.READER.readFrom(bb);
               case 0x14c04:
                   // discriminator value 0x14c04L=0x14c04L for class OFOxmNshSiVer13
                   return OFOxmNshSiVer13.READER.readFrom(bb);
               case 0x14d08:
                   // discriminator value 0x14d08L=0x14d08L for class OFOxmNshSiMaskedVer13
                   return OFOxmNshSiMaskedVer13.READER.readFrom(bb);
               case 0x14a04:
                   // discriminator value 0x14a04L=0x14a04L for class OFOxmNshSpiVer13
                   return OFOxmNshSpiVer13.READER.readFrom(bb);
               case 0x14b08:
                   // discriminator value 0x14b08L=0x14b08L for class OFOxmNshSpiMaskedVer13
                   return OFOxmNshSpiMaskedVer13.READER.readFrom(bb);
               case 0x10004:
