...
class OFOxmNshSpiVer12 implements OFOxmNshSpi {
...
//
    ...
    final static OFOxmNshSpiVer12 DEFAULT = new OFOxmNshSpiVer12(
        DEFAULT_VALUE
    );
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmNshSpi> {
        ...
        public OFOxmNshSpi readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            OFOxmNshSpiVer12 oxmNshSpiVer12 = new OFOxmNshSpiVer12(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmNshSpiVer12);
    ...
    final static OFOxmNshSpiVer12Funnel FUNNEL = new OFOxmNshSpiVer12Funnel();
    static class OFOxmNshSpiVer12Funnel implements Funnel<OFOxmNshSpiVer12> {
    ...
    static class Writer implements OFMessageWriter<OFOxmNshSpiVer12> {
        @Override
