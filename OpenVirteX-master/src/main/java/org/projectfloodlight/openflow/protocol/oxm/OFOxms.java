...
public interface OFOxms {
    ...
    OFOxmNshCh1.Builder buildNshCh1() throws UnsupportedOperationException;
    OFOxmNshCh1 nshCh1(U32 value);
    OFOxmNshCh1Masked.Builder buildNshCh1Masked() throws UnsupportedOperationException;
    OFOxmNshCh1Masked nshCh1Masked(U32 value, U32 mask);
    OFOxmNshCh2.Builder buildNshCh2() throws UnsupportedOperationException;
    OFOxmNshCh2 nshCh2(U32 value);
    OFOxmNshCh2Masked.Builder buildNshCh2Masked() throws UnsupportedOperationException;
    OFOxmNshCh2Masked nshCh2Masked(U32 value, U32 mask);
    OFOxmNshCh3.Builder buildNshCh3() throws UnsupportedOperationException;
    OFOxmNshCh3 nshCh3(U32 value);
    OFOxmNshCh3Masked.Builder buildNshCh3Masked() throws UnsupportedOperationException;
    OFOxmNshCh3Masked nshCh3Masked(U32 value, U32 mask);
    OFOxmNshCh4.Builder buildNshCh4() throws UnsupportedOperationException;
    OFOxmNshCh4 nshCh4(U32 value);
    OFOxmNshCh4Masked.Builder buildNshCh4Masked() throws UnsupportedOperationException;
    OFOxmNshCh4Masked nshCh4Masked(U32 value, U32 mask);
    OFOxmNshSi.Builder buildNshSi() throws UnsupportedOperationException;
    OFOxmNshSi nshSi(U8 value);
    OFOxmNshSiMasked.Builder buildNshSiMasked() throws UnsupportedOperationException;
    OFOxmNshSiMasked nshSiMasked(U8 value, U8 mask);
    OFOxmNshSpi.Builder buildNshSpi() throws UnsupportedOperationException;
    OFOxmNshSpi nshSpi(U32 value);
    OFOxmNshSpiMasked.Builder buildNshSpiMasked() throws UnsupportedOperationException;
    OFOxmNshSpiMasked nshSpiMasked(U32 value, U32 mask);
