...
class OFOxmNshSpiMaskedVer14 implements OFOxmNshSpiMasked {
    private static final Logger logger = LoggerFactory.getLogger(OFOxmNshSpiMaskedVer14.class);
    // version: 1.4
...
//
    ...
    final static OFOxmNshSpiMaskedVer14 DEFAULT = new OFOxmNshSpiMaskedVer14(
        DEFAULT_VALUE, DEFAULT_VALUE_MASK
    );

    // package private constructor - used by readers, builders, and factory
    OFOxmNshSpiMaskedVer14(U32 value, U32 mask) {
        if(value == null) {
            throw new NullPointerException("OFOxmNshSpiMaskedVer14: property value cannot be null");
        }
        if(mask == null) {
            throw new NullPointerException("OFOxmNshSpiMaskedVer14: property mask cannot be null");
        }
        this.value = value;
        this.mask = mask;
    }
    ...
    public OFOxm<U32> getCanonical() {
        if (U32.NO_MASK.equals(mask)) {
            return new OFOxmNshSpiVer14(value);
    ...
    static class BuilderWithParent implements OFOxmNshSpiMasked.Builder {
        final OFOxmNshSpiMaskedVer14 parentMessage;
        ...
        BuilderWithParent(OFOxmNshSpiMaskedVer14 parentMessage) {
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmNshSpiMasked> {
        ...
        public OFOxmNshSpiMasked readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            OFOxmNshSpiMaskedVer14 oxmNshSpiMaskedVer14 = new OFOxmNshSpiMaskedVer14(
                    value,
                      mask
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmNshSpiMaskedVer14);
            return oxmNshSpiMaskedVer14;
        }
    }
    ...
    final static OFOxmNshSpiMaskedVer14Funnel FUNNEL = new OFOxmNshSpiMaskedVer14Funnel();
    static class OFOxmNshSpiMaskedVer14Funnel implements Funnel<OFOxmNshSpiMaskedVer14> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFOxmNshSpiMaskedVer14 message, PrimitiveSink sink) {
            // fixed value property typeLen = 0x14b08L
            sink.putInt(0x14b08);
    ...
    static class Writer implements OFMessageWriter<OFOxmNshSpiMaskedVer14> {
        @Override
        public void write(ChannelBuffer bb, OFOxmNshSpiMaskedVer14 message) {
            // fixed value property typeLen = 0x14b08L
            bb.writeInt(0x14b08);
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFOxmNshSpiMaskedVer14(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFOxmNshSpiMaskedVer14 other = (OFOxmNshSpiMaskedVer14) obj;
