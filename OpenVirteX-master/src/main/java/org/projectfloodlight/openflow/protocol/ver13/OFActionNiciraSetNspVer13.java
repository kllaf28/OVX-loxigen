...
class OFActionNiciraSetNspVer13 implements OFActionNiciraSetNsp {
...
//
    ...
    final static OFActionNiciraSetNspVer13 DEFAULT = new OFActionNiciraSetNspVer13(
        DEFAULT_NSP
    );
    ...
    public OFVersion getVersion() {
        ...
        public OFActionNiciraSetNsp build() {
                ...
                //
                return new OFActionNiciraSetNspVer13(
                    nsp
                );
        }
...
//
    ...
    static class Reader implements OFMessageReader<OFActionNiciraSetNsp> {
        ...
        public OFActionNiciraSetNsp readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            OFActionNiciraSetNspVer13 actionNiciraSetNspVer13 = new OFActionNiciraSetNspVer13(
                    nsp
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", actionNiciraSetNspVer13);
    ...
    final static OFActionNiciraSetNspVer13Funnel FUNNEL = new OFActionNiciraSetNspVer13Funnel();
    static class OFActionNiciraSetNspVer13Funnel implements Funnel<OFActionNiciraSetNspVer13> {
    ...
    static class Writer implements OFMessageWriter<OFActionNiciraSetNspVer13> {
        @Override
