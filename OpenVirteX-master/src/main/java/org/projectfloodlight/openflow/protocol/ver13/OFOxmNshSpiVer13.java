...
class OFOxmNshSpiVer13 implements OFOxmNshSpi {
...
//
    ...
    final static OFOxmNshSpiVer13 DEFAULT = new OFOxmNshSpiVer13(
        DEFAULT_VALUE
    );
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmNshSpi> {
        ...
        public OFOxmNshSpi readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            OFOxmNshSpiVer13 oxmNshSpiVer13 = new OFOxmNshSpiVer13(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmNshSpiVer13);
    ...
    final static OFOxmNshSpiVer13Funnel FUNNEL = new OFOxmNshSpiVer13Funnel();
    static class OFOxmNshSpiVer13Funnel implements Funnel<OFOxmNshSpiVer13> {
    ...
    static class Writer implements OFMessageWriter<OFOxmNshSpiVer13> {
        @Override
