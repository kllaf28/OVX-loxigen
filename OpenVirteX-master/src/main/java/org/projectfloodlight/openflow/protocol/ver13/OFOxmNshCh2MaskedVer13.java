...
class OFOxmNshCh2MaskedVer13 implements OFOxmNshCh2Masked {
    private static final Logger logger = LoggerFactory.getLogger(OFOxmNshCh2MaskedVer13.class);
    // version: 1.3
...
//
    ...
    final static OFOxmNshCh2MaskedVer13 DEFAULT = new OFOxmNshCh2MaskedVer13(
        DEFAULT_VALUE, DEFAULT_VALUE_MASK
    );

    // package private constructor - used by readers, builders, and factory
    OFOxmNshCh2MaskedVer13(U32 value, U32 mask) {
        if(value == null) {
            throw new NullPointerException("OFOxmNshCh2MaskedVer13: property value cannot be null");
        }
        if(mask == null) {
            throw new NullPointerException("OFOxmNshCh2MaskedVer13: property mask cannot be null");
        }
        this.value = value;
        this.mask = mask;
    }
    ...
    public OFOxm<U32> getCanonical() {
        if (U32.NO_MASK.equals(mask)) {
            return new OFOxmNshCh2Ver13(value);
    ...
    static class BuilderWithParent implements OFOxmNshCh2Masked.Builder {
        final OFOxmNshCh2MaskedVer13 parentMessage;
        ...
        BuilderWithParent(OFOxmNshCh2MaskedVer13 parentMessage) {
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmNshCh2Masked> {
        ...
        public OFOxmNshCh2Masked readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            OFOxmNshCh2MaskedVer13 oxmNshCh2MaskedVer13 = new OFOxmNshCh2MaskedVer13(
                    value,
                      mask
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmNshCh2MaskedVer13);
            return oxmNshCh2MaskedVer13;
        }
    }
    ...
    final static OFOxmNshCh2MaskedVer13Funnel FUNNEL = new OFOxmNshCh2MaskedVer13Funnel();
    static class OFOxmNshCh2MaskedVer13Funnel implements Funnel<OFOxmNshCh2MaskedVer13> {
        private static final long serialVersionUID = 1L;
        @Override
        public void funnel(OFOxmNshCh2MaskedVer13 message, PrimitiveSink sink) {
            // fixed value property typeLen = 0x15108L
            sink.putInt(0x15108);
    ...
    static class Writer implements OFMessageWriter<OFOxmNshCh2MaskedVer13> {
        @Override
        public void write(ChannelBuffer bb, OFOxmNshCh2MaskedVer13 message) {
            // fixed value property typeLen = 0x15108L
            bb.writeInt(0x15108);
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("OFOxmNshCh2MaskedVer13(");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OFOxmNshCh2MaskedVer13 other = (OFOxmNshCh2MaskedVer13) obj;
