...
class OFOxmNshCh1Ver14 implements OFOxmNshCh1 {
...
//
    ...
    final static OFOxmNshCh1Ver14 DEFAULT = new OFOxmNshCh1Ver14(
        DEFAULT_VALUE
    );
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmNshCh1> {
        ...
        public OFOxmNshCh1 readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            OFOxmNshCh1Ver14 oxmNshCh1Ver14 = new OFOxmNshCh1Ver14(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmNshCh1Ver14);
    ...
    final static OFOxmNshCh1Ver14Funnel FUNNEL = new OFOxmNshCh1Ver14Funnel();
    static class OFOxmNshCh1Ver14Funnel implements Funnel<OFOxmNshCh1Ver14> {
    ...
    static class Writer implements OFMessageWriter<OFOxmNshCh1Ver14> {
        @Override
