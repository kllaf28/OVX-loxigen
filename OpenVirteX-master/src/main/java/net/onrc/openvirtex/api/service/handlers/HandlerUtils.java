...
public final class HandlerUtils {
    ...
    //yk
    public static void isValidRouteId(final int tenantId, final DatapathId dpid,
    ...
    //yk
    public static void isValidOVXSwitch(final int tenantId, final DatapathId dpid)
    ...
    //yk
    public static void isValidOVXBigSwitch(final int tenantId, final DatapathId dpid)
            throws NetworkMappingException {
        final OVXMap map = OVXMap.getInstance();
        final OVXNetwork virtualNetwork = map.getVirtualNetwork(tenantId);
        OVXSwitch sw = virtualNetwork.getSwitch(dpid);
    ...
    //yk
    public static void isValidDPID(final int tenantId, final List<DatapathId> dpids)
            throws InvalidDPIDException {
        if (dpids.size() < 1) {
            throw new InvalidDPIDException(
        ...
        for (final DatapathId dpid : dpids) {
            ...
            if (dpids.size() > 1) {
                ...
                Set<DatapathId> neighbourDpids = new HashSet<DatapathId>();
    ...
    //yk
    public static void isValidOVXPort(final int tenantId, final DatapathId dpid,
    ...
    //yk
    public static void isValidPhysicalPort(final int tenantId, final DatapathId dpid,
            final short portNumber) throws InvalidPortException,
    ...
    public static void areValidLinkEndPoints(final int tenantId,
            final DatapathId srcDpid, final short ovxSrcPort, final DatapathId dstDpid,
    ...
    public static List<PhysicalLink> getPhysicalPath(String pathString) {
        ...
        for (final String hop : pathString.split(",")) {
            ...
            //yk
            final DatapathId srcDpid = DatapathId.of(srcDpidPort[0]);
            final DatapathId dstDpid = DatapathId.of(dstDpidPort[0]);
