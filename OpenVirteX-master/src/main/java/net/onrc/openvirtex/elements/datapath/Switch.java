...
public abstract class Switch<T extends Port> implements OVXEventHandler,
    ...
    protected DatapathId switchId = DatapathId.of(0);
    ...
    protected Switch(final DatapathId switchId, @Nonnull OFFactory factory) {
    	//yk
    	if(factory == null)
        ...
        this.switchName = this.switchId.toString();
